...
public class QiNiuBaseResponse {
	 ...
	 *            http reponse body
	 */
	public QiNiuBaseResponse(int statusCode, String response) {
	 ...
	 */
	public QiNiuBaseResponse(int statusCode, Exception e) {
		this.statusCode = statusCode;
		this.exception = e;
	}
	 ...
	 * @param ret
	 */
	public QiNiuBaseResponse(QiNiuBaseResponse ret) {
